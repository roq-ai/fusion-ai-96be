...
type ColumnType = ColumnDef<FriendInterface, unknown>;
...
export function FriendListPage(props: FriendListPageProps) {
  ...
  const { data, error, isLoading, mutate } = useSWR<PaginatedInterface<FriendInterface>>(
    () => `/friends?params=${JSON.stringify(params)}`,
    fetcher,
  );
      ...
      : null,
    {
      ...
      cell: ({ row: { original: record } }: any) => (
        <Flex justifyContent="flex-end">
          <NextLink href={`/friends/view/${record.id}`} passHref legacyBehavior>
            <Button
